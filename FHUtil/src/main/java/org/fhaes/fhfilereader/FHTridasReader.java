...
/**
 * Skeleton of new TRiDaS Reader class that when complete can be used to replace FHX2FileReader
 * 
 * @author pwb48
 * 
 */
public class FHTridasReader extends AbstractFireHistoryReader {
	...
	private static final Logger log = LoggerFactory
			.getLogger(FHTridasReader.class);
	...
	public ArrayList<ArrayList<Integer>> getEventDataArrays(
	...
	public ArrayList<ArrayList<Double>> getFilterArrays(
			EventTypeToProcess eventType) {
