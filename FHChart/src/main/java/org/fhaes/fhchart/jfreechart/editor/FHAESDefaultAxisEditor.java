 ...
 */
class FHAESDefaultAxisEditor extends JPanel implements ActionListener {
...
// private InsetsTextField labelInsetsTextField;
	 ...
	 */
	public static FHAESDefaultAxisEditor getInstance(Axis axis) {
		...
		if (axis != null)
		{
			...
			{
				return new FHAESDefaultAxisEditor(axis);
			}
		}
		else
		{
	 ...
	 * @param axis the axis whose properties are to be displayed/edited in the panel.
	 */
	public FHAESDefaultAxisEditor(Axis axis) {
		...
		general.setBorder(new TitledBorder(null, "Axis Label", TitledBorder.LEADING, TitledBorder.TOP, null, null));
...
// interior.add(b);
		...
		other.setBorder(new TitledBorder(null, "Ticks and Range", TitledBorder.LEADING, TitledBorder.TOP, null, null));
