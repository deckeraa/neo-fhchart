 ...
 */
class FHAESChartEditor extends JPanel implements ActionListener, ChartEditor {

	private static final long serialVersionUID = 1L;

	/** A panel for displaying/editing the properties of the title. */
	private FHAESTitleEditor titleEditor;
	 ...
	 */
	public FHAESChartEditor(JFreeChart chart) {
		...
		this.titleEditor = new FHAESTitleEditor(title);
	 ...
	 */
	public FHAESTitleEditor getTitleEditor() {
	...
	/**
	 * Allows the user the opportunity to select a new background paint. Uses JColorChooser, so we are only allowing a subset of all Paint
	 * objects to be selected (fix later).
	 */
